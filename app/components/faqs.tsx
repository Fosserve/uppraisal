...
export default function Faqs() {
  return (
    <div className="bg-background">
      <div className="mx-auto max-w-7xl divide-y divide-border/10 px-6 py-12 sm:py-16 lg:px-8   ">
        <h2 className="text-4xl font-semibold tracking-tight text-foreground sm:text-5xl sm:text-center">Frequently asked questions</h2>
        <dl className="mt-10 space-y-8 divide-y divide-border/10">
          {faqs.map((faq) => (

...
export default function Testimonials() {
  return (
    <div className="relative isolate bg-background py-12 sm:py-16">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm/6 text-foreground sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
          <figure className="rounded-2xl bg-card ring-1 shadow-lg ring-border sm:col-span-2 xl:col-start-2 xl:row-end-1">
            <blockquote className="p-6 text-lg font-semibold italic tracking-tight text-card-foreground sm:p-12 sm:text-xl/8">
            ...
            <figcaption className="flex flex-wrap items-center gap-x-4 gap-y-4 border-t border-border px-6 py-4 sm:flex-nowrap">
              <Image
                ...
                className="size-10 flex-none rounded-full bg-muted object-cover"
                width={40}
                height={40}
              />
              ...
              <Image alt="" src={featuredTestimonial.author.logoUrl} className="h-10 w-auto flex-none" />
            </figcaption>
          </figure>
                ...
                >
                  {column.map((testimonial) => (
                    <figure
                      ...
                      className="rounded-2xl bg-card p-6 ring-1 shadow-lg ring-border"
                    >
                      <blockquote className="text-card-foreground italic">
                        <p>{`“${testimonial.body}”`}</p>
                      </blockquote>
                      <figcaption className="mt-6 flex items-center gap-x-4">
                        <Image alt={testimonial.author.name} src={testimonial.author.imageUrl} className="size-10 rounded-full bg-muted object-cover" width={40} height={40} />
                        <div>
